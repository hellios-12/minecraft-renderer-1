#!/usr/bin/env node
/* eslint-disable */
// Genitirt fixtures dlya dump-poc.
// Zapuskat iz kornya minecraft-renderer:  node dump-poc/generate-fixtures.cjs
//
// Idempotent: peregenerit faily v dump-poc/fixtures/ pri kazhdom zapuske.
